    ...
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="panel p-6">
          ...
          <label className={`btn-ghost inline-flex ${isGuest ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}>
            {busy ? 'Uploading…' : 'Choose CSV file'}
            <input type="file" accept=".csv" className="hidden" disabled={busy || isGuest}
        ...
        <div className="panel p-6">
          ...
          <button className="btn-primary" disabled={busy || isGuest} onClick={handleSynthetic}>
